...
class PluginTranslation(
    ...
    val wrongMessageLen: StringDesc.Raw = StringDesc.Raw( "&#ca271bДлина причина рейтинга должна быть в диапазоне [5;30]"),
    ...
    val alreadyMaxDayVotes: StringDesc.Raw = StringDesc.Raw( "&#ca271bВы уже проголосовали максимальное количество раз за день"),
    @SerialName("general.max_player_voted")
    val alreadyMaxPlayerVotes: StringDesc.Raw = StringDesc.Raw( "&#ca271bСегодня вы выдали максимальное возможное количество голосов этому игроку"),
