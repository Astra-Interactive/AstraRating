...
class PluginTranslation:BaseTranslation() {
    ...
    val dbSuccess: String =
        translationValue("database.success","#1B76CAУспешно подключено к базе данных")
    ...
    val reloadComplete: String =
        translationValue("general.reload_complete","#1B76CAПерезагрузка успешно завершена")
    val noPermission: String =
        translationValue("general.no_permission","#ca271bУ вас нет прав!")
    val onlyPlayerCommand:String = translationValue("general.only_player_command","#ca271bКоманда доступна только игрокам!")
    val playerNotExists:String = translationValue("general.player_not_exists","#ca271bТакого игрока нет!")
    val cantRateSelf:String = translationValue("general.cant_rate_self","#ca271bВы не можете поставить рейтинг самому себe!")
    val wrongMessageLen:String = translationValue("general.wrong_message_len","#ca271bДлина причина рейтинга должна быть в диапазоне [5;30]")
    ...
    val alreadyMaxDayVotes:String = translationValue("general.max_day_voted","#ca271bВы уже проголосовали максимальное количество раз за день")
    val alreadyMaxPlayerVotes:String = translationValue("general.max_player_voted","#ca271bСегодня вы выдали максимальное возможное количество голосов этому игроку")
    val clickToDeleteReport:String = translationValue("general.click_to_delete_report","#ca271bНажмите ЛКМ чтобы удалить")
    val notEnoughOnServer:String = translationValue("general.not_enough_on_server","#ca271bВы недостаточно долго были на сервере")
    val notEnoughOnDiscord:String = translationValue("general.not_enough_on_discord","#ca271bВы недостаточно долго были на дискорд-сервере")
    val needDiscordLinked:String = translationValue("general.need_discord_link","#ca271bВы должны привязать дискорд /discord link")
