...
class PluginTranslation {
    ...
    val clickToDeleteReport:String = getHEXString("general.click_to_delete_report") ?: "#ca271bНажмите ЛКМ чтобы удалить".HEX()
    val notEnoughOnServer:String = getHEXString("general.not_enough_on_server") ?: "#ca271bВы недостаточно долго были на сервере".HEX()
    val notEnoughOnDiscord:String = getHEXString("general.not_enough_on_discord") ?: "#ca271bВы недостаточно долго были на дискорд-сервере".HEX()
    val needDiscordLinked:String = getHEXString("general.need_discord_link") ?: "#ca271bВы должны привязать дискорд /discord link".HEX()
